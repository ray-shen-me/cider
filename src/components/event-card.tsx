...
const dateArrayToDate = (dateArray: number[]): Date => {
    return new Date(`${dateArray[1]}-${dateArray[2].toString().padStart(2, '0')}-${dateArray[0].toString().padStart(2, '0')} ${(dateArray[3] || 0).toString().padStart(2, '0')}:${(dateArray[4] || 0).toString().padStart(2, '0')}:00`);
}
